...
def calcular_integral():
    ...
    try:
        ...
        # Mostrar el resultado junto con " + C " al lado derecho
        resultado_text = f'{pretty_res} + C'
        resultado.config(text=resultado_text)  # Muestra la respuesta en la interfaz
    except:
...
boton_borrar_todo.grid(row=row, column=col, padx=5, pady=5)
